...
class Database:
    ...
    def make_target(self,atoms,use_derivatives=True,use_negative_forces=True,**kwargs):
        """
        ...
        Returns:
            (1) array: The energy of the atoms object if use_derivatives=False.
                or
            (1,1+3*Nat) array: The energy and derivatives if use_derivatives=True.
        """
