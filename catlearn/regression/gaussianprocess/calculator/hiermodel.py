...
class HierarchicalMLModel(MLModel):
    def __init__(self,model=None,database=None,baseline=None,optimize=True,hp=None,pdis=None,verbose=False,npoints=25,initial_indicies=[0],**kwargs):
        """
        A hierarchy of Machine Learning model used for ASE Atoms and calculator.
        A new model is made when the number of data points exceed the number of points.
        ...
        Parameters:
            ...
            initial_indicies : list
                The indicies of the data points that must be included in the used data base for every model.
        """
        super().__init__(model=model,
                         ...
                         **kwargs)
        # Set the arguments
        self.update_arguments(npoints=npoints,
    ...
    def add_training(self,atoms_list,**kwargs):
        ...
        if data_len+len(atoms_list)<=self.npoints:
            ...
            self.baseline=MLCalculator(mlmodel=self.copy(),calculate_forces=True,calculate_uncertainty=False)
            ...
            raise Exception('New baseline model can not be made without training. Include one point at the time!')
        return self
    
    def update_arguments(self,model=None,database=None,baseline=None,optimize=None,hp=None,pdis=None,verbose=None,npoints=None,initial_indicies=None,**kwargs):
        """
