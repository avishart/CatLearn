...
class FingerprintWrapperGPAtom(Fingerprint):
    def __init__(self,fingerprint,reduce_dimensions=True,use_derivatives=True,**kwargs):
        """ 
    ...
    def update_arguments(self,fingerprint=None,reduce_dimensions=None,use_derivatives=None,**kwargs):
        """
...
class FingerprintWrapperDScribe(Fingerprint):
    def __init__(self,fingerprint,reduce_dimensions=True,use_derivatives=True,fingerprint_kwargs={},**kwargs):
        """ 
        Fingerprint constructer class that convert atoms object into a fingerprint object with vector and derivatives.
        The fingerprint is generated by wrapping the fingerprint class from dscribe (>=2.1).
    ...
    def update_arguments(self,fingerprint=None,reduce_dimensions=None,use_derivatives=None,fingerprint_kwargs=None,**kwargs):
        """
        Update the class with its arguments. The existing arguments are used if they are not given.
