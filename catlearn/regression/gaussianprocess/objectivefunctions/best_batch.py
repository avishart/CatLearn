...
class BestBatchFuction(BatchFuction):
    def __init__(self,func,get_prior_mean=False,batch_size=25,equal_size=False,use_same_prior_mean=True,seed=1,**kwargs):
        ...
        The lowest function value and it corresponding hyperparameters from a single batch are used.
    ...
    def function(self,theta,parameters,model,X,Y,pdis=None,jac=False,**kwargs):
        ...
        for i_batch in i_batches:
            ...
            f=self.func.function(theta,parameters,model,X_split,Y_split,pdis=pdis,jac=jac,**kwargs)
            if jac:
                f,d=f
