...
class Prior_distribution:
    ...
    def ln_pdf(self, x):
        ...
        Returns:
            ...
            or
            (M) array: M values of the log of probability density function
                if M different values is given.
        """
    ...
    def ln_deriv(self, x):
        """
        The derivative of the log of the probability density function
        as respect to x.
        """
        raise NotImplementedError()
    ...
    def mean_var(self, mean, var):
        """
        Obtain the parameters of the distribution function by
